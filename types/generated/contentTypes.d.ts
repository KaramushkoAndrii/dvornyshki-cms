...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutUsList: Schema.Attribute.Component<'lists.about-us', true> &
...
export interface ApiAboutSectionAboutSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    aboutItem: Schema.Attribute.Component<'item.item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    statistic: Schema.Attribute.Component<'statistics.about-statistic', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiAdviceSectionAdviceSection extends Struct.SingleTypeSchema {
  collectionName: 'advice_sections';
  info: {
    displayName: 'AdviceSection';
    pluralName: 'advice-sections';
    singularName: 'advice-section';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    adviceItem: Schema.Attribute.Component<'lists.advice', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::advice-section.advice-section'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiContactFormDataContactFormData
  ...
  collectionName: 'contacts_form_data';
  info: {
    displayName: 'contactFormData';
    pluralName: 'contacts-form-data';
  ...
  attributes: {
    contactFormItem: Schema.Attribute.Component<'lists.contact-form', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiContactHeroSectionContactHeroSection
  extends Struct.SingleTypeSchema {
  collectionName: 'contact_hero_sections';
  info: {
    displayName: 'ContactHeroSection';
    pluralName: 'contact-hero-sections';
    singularName: 'contact-hero-section';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    headerContent: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiHelpPageHelpPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    helpListDetailed: Schema.Attribute.Component<
      'lists.help-list-detailed',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiHelpSectionHelpSection extends Struct.SingleTypeSchema {
  collectionName: 'help_sections';
  info: {
    displayName: 'HelpSection';
    pluralName: 'help-sections';
    singularName: 'help-section';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    helpListItem: Schema.Attribute.Component<'lists.help', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiOurAnimalOurAnimal extends Struct.SingleTypeSchema {
  ...
  info: {
    displayName: 'OurAnimal';
    pluralName: 'our-animals';
    singularName: 'our-animal';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    cats: Schema.Attribute.Component<'lists.our-animals', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dogs: Schema.Attribute.Component<'lists.our-animals', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiSearchSectionSearchSection extends Struct.SingleTypeSchema {
  ...
  info: {
    ...
    pluralName: 'search-sections';
    singularName: 'search-section';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    btnAbout: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    btnRerol: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::search-section.search-section'
    >;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
